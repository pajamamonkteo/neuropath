...
import { planContainsQuizTask, QUIZ_FREE_PLAN_INSTRUCTIONS } from '../../../lib/plan-content';
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return Response.json({ plan: { ...plan, tasks }, source: 'ai' });
